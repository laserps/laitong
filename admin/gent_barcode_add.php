...
function ean13_check_digit($digits){
	...
	//$rs_check = $sys->record("tb_product", "dm_product = '".$_POST['dm_product']."' or barcode_product = '".$_POST['dm_product']."'" );


	if($rs_check->id_product ==""){
	$num_1  = substr($_POST['dm_product'], -4,13);
	$num_2  = substr($_POST['dm_product'], 0,-4);
	$new_bar =  $num_2.$num_1;
