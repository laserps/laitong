				...
				<table class="th2" cellpadding="5" border="0">
					...
					<tr>
					  <td width = "15%" align = "right">
						Barcode#:</td><td><input  type="text" name="dm_product" id = "dm_product" style ="width:150px;" value = "<?php echo $_POST['dm_product'];?>" onkeyup = "timeMsg();">
				      </td>
					</tr>

					<tr>
					  <td width = "15%" align = "right">
						Dm#:</td><td><input  type="text" name="dm_product_t" id = "dm_product_t" style ="width:150px;" value = "<?php echo $rs->dm_product?>">&nbsp;&nbsp;
				      </td>
					</tr>
