...
$sys->delete("tb_invoice", " invoice_no = '".$_POST['invoice_no']."' and id_product = '".$_POST['id_product']."' ");

$data =array("total_product"=>1);

$sys->update("tb_product", $data, " id_product = '".$_POST['id_product']."'  ");
