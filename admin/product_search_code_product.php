...
if($_POST['code_product'] != ""){

$row	  = $sys->result("tb_product,tb_stock",'code_product like  "%'.$_POST['code_product'].'%" and tb_product.id_stock = tb_stock.id_stock ', 'dm_product asc', "30");
?>
