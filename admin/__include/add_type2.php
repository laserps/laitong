<?php  
	...
	if($_POST['id'] != ""){
		$sys->Edit($data,$_POST['id_color'],$tbl,"main.php?op=type2&act=list",$fiel_id,$_POST['id']);
	}
	...
	if(($_POST['save'] == "news_add") and ($_GET['id'] == "")){
		$sys->Add($data,$tbl,"main.php?op=type2&act=list");
	}
...
<table width="100%" cellspacing="0" cellpadding="1" border="0">
    <tr>
        <td height="40" align="center"><table width="100%" cellpadding="0" cellspacing="0"><tr>
          <td bgcolor="#BBD8EC" align="center" height="40" class="th"><?php echo ($_GET['id'])? 'แก้ไข' : 'เพิ่ม' ;?>รูปแบบ ตลับ</td>
        </tr></table></td>
    </tr>
    <tr>
        <td align="center">
		...
		<tr height="30" class="l">
			<td width="100%" align="left" bgcolor="#E7F1F8">
				<table class="th2" cellpadding="5" border="0" width = "100%">
					...
					<tr>
					  <td align = "center">
					  <input type="hidden" name="num_type_product" value = "1">
