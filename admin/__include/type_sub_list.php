...
<?php  
	...
	if($_POST['save'] == "news_add"){
			...
			<!--
				...
				window.location.replace("main.php?op=type_sub&act=list");
			//-->
			</script>';
...
<table width="100%" cellspacing="0" cellpadding="1" border="0" >
    <tr>
        <td align="center"><table width="100%" cellpadding="0" cellspacing="0"><tr>
          <td bgcolor="#BBD8EC" align="center" height="40" class="th"><input type="button" value="<<<ตั้งค่าซิ-ค่าแรง" onclick="window.location.replace('main.php?op=setting_&act=list');">&nbsp;&nbsp;จัดการค่าแรงตั้งต้น(<span style = "color:#ff0000" >นอกเครือ</span>)</td>
        </tr></table></td>
    </tr>
