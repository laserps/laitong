...
<?php  
	...
	if($_POST['save'] == "news_add"){
			...
			foreach($_POST['id_type'] as $rs_id_type){
					...
					$sys->db->delete("tb_wage_first_".$c_."", " id_type = '".$rs_id_type."' and branch_type = '2' ");
			...
			<!--
				...
				window.location.replace("main.php?op=type2_sub&act=list");
			//-->
			</script>';
...
<table width="100%" cellspacing="0" cellpadding="1" border="0" >
    <tr>
        <td align="center"><table width="100%" cellpadding="0" cellspacing="0"><tr>
          <td bgcolor="#BBD8EC" align="center" height="40" class="th"><input type="button" value="<<<ตั้งค่าซิ-ค่าแรง" onclick="window.location.replace('main.php?op=setting_&act=list');">&nbsp;&nbsp;จัดการค่าแรงตั้งต้น ตลับ(<span style = "color:#ff0000" >นอกเครือ</span>)</td>
        </tr></table></td>
    </tr>
	...
	<FORM name="myForm" METHOD="POST" ACTION="main.php?op=type2_sub&act=list">
    <tr>
        <td>
			...
			<table class="th2" cellpadding="0" cellspacing = "0" border="1" width = "100%">
					...
					foreach($row as $rs){
							...
							$rs_wage = $sys->db->record("tb_wage_first_".$c_.""," id_type = '".$rs->id_type_product."' and branch_type = '2'  ");
						?>
					  <tr >
					    <?php if($i==0){?><td >
