...
?>
    <tr height="25" bgcolor="<?php echo $bgc?>" align="center" class="tb">
	  ...
	  <td>
		<?php echo '<a href="report_qc.php?id_stock='.$_SESSION['id_stock'].'&id_category='.$rs->id_category.'" target = "_blank"><img src="images/b_print.gif" width="16" height="16" border="0" alt=""></a>&nbsp;&nbsp;&nbsp;';?>
	  </td>
