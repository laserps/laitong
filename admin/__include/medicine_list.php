...
<?php  
	$row		= $sys->dataList($tbl,$id=null,50,"id_medicine","asc",$join);
...
<table width="100%" cellspacing="0" cellpadding="1" border="0" >
    <tr>
        <td align="center"><table width="100%" cellpadding="0" cellspacing="0"><tr>
          <td bgcolor="#BBD8EC" align="center" height="40" class="th"><input type="button" value="<<<ตั้งค่าซิ-ค่าแรง" onclick="window.location.replace('main.php?op=setting_&act=list');">จัดการลงยา</td>
        </tr></table></td>
    </tr>
    ...
    <tr height="30" bgcolor="#BBD8EC">
	  ...
	  <td align="center" bgcolor="#BBD8EC" class="th">ชื่อลงยา</td>
...
?>
    <tr height="25" bgcolor="<?php echo $bgc?>" align="center" class="tb">
	  ...
	  <a href="main.php?op=<?php echo $_GET['op'];?>&act=add&amp;rd=<?php echo rand(1,99999); ?>&id=<?php echo $rs->id_medicine;?>">
	  <img src="images/document_edit.png" border="0" title="Edit" /></a> &nbsp; <a href="main.php?op=<?php echo $_GET[op];?>&act=list&amp;rd=<?php echo rand(1,99999); ?>&amp;del=<?php echo $rs->id_medicine?>"><img src="images/file_delete.png" border="0" title="Delete" onClick="return Conf('<?php echo $rs->name_medicine;?>')" /></a> 
	  </td>
