...
<table width="100%" cellspacing="0" cellpadding="1" border="0">
    <tr>
        <td height="40" align="center"><table width="100%" cellpadding="0" cellspacing="0"><tr>
          <td bgcolor="#BBD8EC" align="center" height="40" class="th"><?php echo ($_GET['id'])? 'แก้ไข' : 'เพิ่ม' ;?> พิมพ์กรอบ</td>
        </tr></table></td>
    </tr>
    <tr>
        <td align="center">
		...
		<tr height="30" class="l">
			...
			<td width="88%" align="left" bgcolor="#E7F1F8">
				<table class="th2" cellpadding="5" border="0">
					...
					<tr>
					  <td align="right" class="r">รหัสพิมพ์กรอบ: </td>
					  <td><input name="num_category" type="text" class="box" id="num_category" style="border:dotted; border-color:#0000FF; width:50px"  value="<?php echo $rs->num_category;?>"/>
				      </td>
					</tr>

					<tr>
					  <td align="right" class="r">ชื่อพิมพ์กรอบ: </td>
					  <td><input name="name_category" type="text" class="box" id="name_category" style="border:dotted; border-color:#0000FF; width:350px"  value="<?php echo $rs->name_category;?>"/>
				      </td>
					</tr>
					...
					<tr>
					  ...
					  <INPUT TYPE="hidden" NAME="id" value = "<?php echo $rs->id_category;?>">
