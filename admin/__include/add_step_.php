<?php  
	...
	if($_POST['id'] != ""){
		$sys->Edit($data,$_POST['id_color'],$tbl,$page_admin,$fiel_id,$_POST['id']);
	}
	...
	if(($_POST['save'] == "news_add") and ($_GET['id'] == "")){
		unset($_POST['save']);
		$sys->Add($data,$_POST['id_color'],$tbl,$page_admin);
	}
...
<table width="100%" cellspacing="0" cellpadding="1" border="0">
    <tr>
        <td height="40" align="center"><table width="100%" cellpadding="0" cellspacing="0"><tr>
          <td bgcolor="#BBD8EC" align="center" height="40" class="th"><?php echo ($_GET['id'])? 'แก้ไข' : 'เพิ่ม' ;?>วิธีชุบ</td>
        </tr></table></td>
    </tr>
    <tr>
        <td align="center">
		...
		<tr height="30" class="l">
			...
			<td width="88%" align="left" bgcolor="#E7F1F8">
				<table class="th2" cellpadding="5" border="0">
				   ...
				   <!-- <tr>
					  <td align="right" class="r">รหัสวิธีชุบ: </td>
					  <td><input name="num_type_product" type="text" class="box" id="name_type_product" style="border:dotted; border-color:#0000FF; width:80px"  value="<?php echo $rs->num_type_product;?>"/>
				      </td>
					</tr> -->


					<tr>
					  <td align="right" class="r">วิธีชุบ: </td>
					  <td><input name="num_type_product" type="text" class="box" id="name_type_product" style="border:dotted; border-color:#0000FF; width:250px"  value="<?php echo $rs->num_type_product;?>"/>
				      </td>
					</tr>
