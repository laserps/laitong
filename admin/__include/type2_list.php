	...
	if($_POST['save'] == "news_add"){
			...
			foreach($_POST['id_type'] as $rs_id_type){
					...
					$data_ = array(
						...
						"wage_first_one__"	=>	$_POST['wage_first_one__'.$rs_id_type.$c_.''][0],
						"wage_first_two__"	=>	$_POST['wage_first_two__'.$rs_id_type.$c_.''][1],
						"wage_first_three__"	=>	$_POST['wage_first_three__'.$rs_id_type.$c_.''][2],
						"wage_first_four__"	=>	$_POST['wage_first_four__'.$rs_id_type.$c_.''][3],
			...
			<!--
				...
				window.location.replace("main.php?op=type2&act=list");
			//-->
			</script>';
...
<table width="100%" cellspacing="0" cellpadding="1" border="0" >
    <tr>
        <td align="center"><table width="100%" cellpadding="0" cellspacing="0"><tr>
          <td bgcolor="#BBD8EC" align="center" height="40" class="th"><input type="button" value="<<<ตั้งค่าซิ-ค่าแรง" onclick="window.location.replace('main.php?op=setting_&act=list');">&nbsp;&nbsp;จัดการค่าแรงตั้งต้น ตลับ(<span style = "color:#ff0000" >ในเครือ</span>)</td>
        </tr></table></td>
    </tr>
	...
	<FORM name="myForm" METHOD="POST" ACTION="main.php?op=type2&act=list">
    <tr>
        <td>
			...
			<table class="th2" cellpadding="0" cellspacing = "0" border="1" width = "100%">
					...
					<tr >
					  ...
					  <tr>
						...
						<td align="center" colspan = "1">เปิดหลัง</td>
						<td align="center" colspan = "1">ปิดหลัง</td>
						<td align="center" colspan = "1">ปิดหลังแกะภาพ</td>
					  </tr>
					...
					foreach($row as $rs){
					  ...
					  <tr >
						...
						<b>
						<a href="main.php?op=<?php echo $_GET[op];?>&act=list&amp;rd=<?php echo rand(1,99999); ?>&amp;del=<?php echo $rs->id_type_product;?>"><img src="images/file_delete.png" border="0" title="Delete" onClick="return Conf('<?php echo $rs->code_product;?>')" /></a>&nbsp;&nbsp;
						<?php echo $rs->name_type_product?></b></td><?php }?>
						...
						<td align="center" colspan = "1"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td align = "center"><input type="text" name="wage_first_one__<?php echo $rs->id_type_product.$c_;?>[0]" style = "width:25px;" value = "<?php echo $rs_wage->wage_first_one__;?>"></td>
                            <td align = "center"><input type="text" name="wage_first_two__<?php echo $rs->id_type_product.$c_;?>[1]" style = "width:25px;" value = "<?php echo $rs_wage->wage_first_two__;?>"></td>
                            <td align = "center"><input type="text" name="wage_first_three__<?php echo $rs->id_type_product.$c_;?>[2]" style = "width:25px;" value = "<?php echo $rs_wage->wage_first_three__;?>"></td>
                            <td align = "center"><input type="text" name="wage_first_four__<?php echo $rs->id_type_product.$c_;?>[3]" style = "width:25px;" value = "<?php echo $rs_wage->wage_first_four__;?>"></td>
                          </tr>
                        </table></td>
