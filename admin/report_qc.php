...
header("Content-Disposition: attachment; filename=report.xls");
	...
	$row		= $sys->dataList($tbl,null,100000,"id_product","desc",$join.' where tb_product.id_stock = "'.$_GET['id_stock'].'"  and tb_product.id_category ='.$_GET['id_category'].'   and tb_product.total_product > "0" ',$_REQUEST['fiel_search'],$_REQUEST['key_search']);
	
	$rs_category    = $db->record("tb_category"," id_category = '".$_GET['id_category']."' ");
...
<table width="895" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td class="f10" colspan = "2"><strong class="f11">ประเภท</strong> :</td>
    <td class="f10" align = "left"><?php echo $rs_category->name_category;?></td>
    <td class="f14">&nbsp;</td>
    <td class="f14">&nbsp;</td>
    <td class="f14">&nbsp;</td>
    <td class="f14">&nbsp;</td>
